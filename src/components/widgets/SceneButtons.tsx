    ...
    <div className="flex gap-2">
      {scenes.map((scene) => (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-bg-tertiary text-gray-300
            text-sm font-medium hover:bg-bg-tertiary/80 hover:text-white transition-all active:scale-95"
        >
          <scene.icon size={18} />
          {scene.label}
        </button>
