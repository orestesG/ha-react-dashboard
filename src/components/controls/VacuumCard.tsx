    ...
    <div className="bg-bg-secondary rounded-2xl p-5 border border-bg-tertiary">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <Bot size={22} className={isDocked ? "text-gray-500" : "text-accent-blue"} />
      ...
      <div className="flex gap-2">
        ...
        <button onClick={returnToBase}
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-bg-tertiary text-gray-400 text-sm font-medium hover:text-white transition-all">
          <Home size={16} /> Base
        </button>
      </div>
    </div>
